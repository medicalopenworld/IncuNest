...
public:
   ...
   */
  FT23x(uint16_t pid, const cdc_acm_host_device_config_t *dev_config,
...
private:
   ...
   * rate divisor is an integer plus a sub-integer prescaler. Allowed values for
   * the Baud rate divisor are: Divisor = n + 0, 0.125, 0.25, 0.375, 0.5, 0.625,
   * 0.75, 0.875; where n is an integer between 2 and 16384 (214).
   *
