...
void ui_ScreenSettings_screen_init(void) {
  ...
  lv_obj_set_y(ui_WifiConnectButton, -13);
  ...
  lv_obj_set_height(ui_WifiConnectedCont, 60);
  lv_obj_set_x(ui_WifiConnectedCont, 174);
  lv_obj_set_y(ui_WifiConnectedCont, -180);
  ...
  lv_obj_set_y(ui_WifiConnectedPanel, 0);
  ...
  lv_obj_set_style_bg_color(ui_WifiConnectedPanel, lv_color_hex(0xFFFFFF),
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_bg_opa(ui_WifiConnectedPanel, 255,
                          LV_PART_MAIN | LV_STATE_DEFAULT);
