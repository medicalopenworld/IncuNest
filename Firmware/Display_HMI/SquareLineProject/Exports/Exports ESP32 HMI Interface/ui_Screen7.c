...
void ui_ScreenIntro_screen_init(void)
{
    ...
    lv_obj_set_style_bg_color(ui_ScreenIntro, lv_color_hex(0x242323), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_ScreenIntro, 255, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_LockButton = lv_imgbtn_create(ui_ScreenIntro);
    ...
    ui_Container1 = lv_obj_create(ui_ScreenIntro);
    ...
    ui_Container2 = lv_obj_create(ui_ScreenIntro);
    ...
    ui_Container4 = lv_obj_create(ui_ScreenIntro);
