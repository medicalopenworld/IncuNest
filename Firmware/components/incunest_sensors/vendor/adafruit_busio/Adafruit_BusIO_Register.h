...
public:
  ...
  // PARCHE INCUNEST: print()/println() volcaban a un Stream de Arduino. Son
  // ayudas de depuracion que este firmware no llama, y eran lo unico de esta
  // libreria que dependia de Stream y de Serial. Se retiran.
#else
  // PARCHE INCUNEST: ver arriba, depuracion sobre Stream retirada.
#endif
