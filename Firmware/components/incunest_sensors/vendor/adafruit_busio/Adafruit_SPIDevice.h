...
public:
  ...
  Adafruit_SPIDevice(int8_t cspin, uint32_t freq = 1000000,
                     ...
                     uint8_t dataMode = SPI_MODE0, SpiBus *theSPI = &SPI);
#else
  Adafruit_SPIDevice(int8_t cspin, uint32_t freq = 1000000,
                     BusIOBitOrder dataOrder = SPI_BITORDER_MSBFIRST,
                     uint8_t dataMode = SPI_MODE0, SpiBus *theSPI = nullptr);
#endif
