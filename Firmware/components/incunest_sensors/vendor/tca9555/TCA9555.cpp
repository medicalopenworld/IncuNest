...
TCA9555::TCA9555(uint8_t address, I2cBus *wire)
{
  _address = address;
  _wire    = wire;
  _error   = TCA9555_OK;
...
//
TCA9535::TCA9535(uint8_t address, I2cBus *wire)
        :TCA9555(address, wire)
{
  _type = 35;
}

PCA9555::PCA9555(uint8_t address, I2cBus *wire)
        :TCA9555(address, wire)
{
  _type = 55;
}

PCA9535::PCA9535(uint8_t address, I2cBus *wire)
        :TCA9555(address, wire)
{
  _type = 35;
}

CAT9555::CAT9555(uint8_t address, I2cBus *wire)
        :TCA9555(address, wire)
{
  _type = 55;
}
