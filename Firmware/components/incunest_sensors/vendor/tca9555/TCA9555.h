...
{
public:
  TCA9555(uint8_t address, I2cBus *wire = &Wire);
...
{
public:
  TCA9535(uint8_t address, I2cBus *wire = &Wire);
};

class PCA9555 : public TCA9555
{
public:
  PCA9555(uint8_t address, I2cBus *wire = &Wire);
};

class PCA9535 : public TCA9555
{
public:
  PCA9535(uint8_t address, I2cBus *wire = &Wire);
};

class CAT9555 : public TCA9555
{
public:
  CAT9555(uint8_t address, I2cBus *wire = &Wire);
};
