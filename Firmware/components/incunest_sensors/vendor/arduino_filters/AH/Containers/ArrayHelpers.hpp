...
// PARCHE INCUNEST: estos operator<< vuelcan un Array a un Print de Arduino.
// Son ayudas de impresion para depuracion; sin Arduino no hay Print y este
// firmware no los usa (de AH solo se usan Timer<micros> y el Butterworth).
#ifdef ARDUINO
template <class T, size_t N, bool Reverse, bool Const>
