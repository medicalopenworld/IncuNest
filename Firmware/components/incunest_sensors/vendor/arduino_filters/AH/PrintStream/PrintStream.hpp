...
// PARCHE INCUNEST: esta cabecera define operadores << sobre el Print de
// Arduino, y solo la usan las macros DEBUG* de AH. Sin Arduino no hay Print,
// y este firmware no usa nada de la parte de depuracion de AH — de todo el
// paquete solo se usan Timer<micros> y el Butterworth de sexto orden. Se
// desactiva entera en vez de inventar un Print propio que nadie llamaria.
#ifdef ARDUINO
