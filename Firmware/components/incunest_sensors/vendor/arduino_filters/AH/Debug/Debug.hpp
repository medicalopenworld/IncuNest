...
// PARCHE INCUNEST: PrintStream.hpp implementa los operadores << sobre el
// Print de Arduino, que no existe aqui. Este fichero solo lo necesitaba para
// las macros DEBUG*, y esas macros ya quedan vacias sin ARDUINO definido
// (ver mas abajo). De todo AH, este firmware solo usa Timer<micros> y el
// Butterworth; nada de la parte de depuracion.
#ifdef ARDUINO
