...
- [ ] Fase 1 — Transporte USB CDC (`usb_comm`): proyecto ESP-IDF + framing + CRC16 + tareas RX/TX + comando `status` (`feat/sb-phase1-usb-cdc`)
- [ ] Fase 2 — Sensores ambientales: SHT40 ×3 en dos buses I2C + ALS analógico en ADC, `sensor_task` + evento `sensor_data` (`feat/sb-phase2-env-sensors`)
- [ ] Fase 4 — Sensor de puerta: hall DRV5032 en IO47, ISR→cola, eventos `door_open`/`door_closed` (`feat/sb-phase4-door`)
