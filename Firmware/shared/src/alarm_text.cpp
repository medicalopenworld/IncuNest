...
const char *alarm_action_text(AlarmId id, Language lang) {
  switch (id) {
    ...
    case ALARM_AIR_TEMP_DEVIATION_HIGH:
      ES("CALEFACTOR CORTADO - AIRE MAS DE 1 C SOBRE LA CONSIGNA");
      FR("CHAUFFAGE COUPE - AIR A PLUS DE 1 C AU DESSUS DE LA CONSIGNE");
      PT("AQUECEDOR CORTADO - AR MAIS DE 1 C ACIMA DO VALOR DEFINIDO");
      return "HEATER CUT - AIR OVER 1 C ABOVE SETPOINT";
    case ALARM_AIR_TEMP_DEVIATION_LOW:
      ES("AIRE MAS DE 1 C BAJO LA CONSIGNA");
      FR("AIR A PLUS DE 1 C SOUS LA CONSIGNE");
      PT("AR MAIS DE 1 C ABAIXO DO VALOR DEFINIDO");
      return "AIR OVER 1 C BELOW SETPOINT";
    case ALARM_SKIN_TEMP_DEVIATION_HIGH:
